                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <div class="flex items-center justify-between gap-4">
                                        <form action="{{ route('cart.update', $item) }}" method="POST" class="flex items-center gap-2">
                                            @csrf
                                            @method('PATCH')
                                            <button type="button" onclick="decreaseQty(this)" class="px-2 py-1 bg-gray-100 rounded hover:bg-gray-200">−</button>
                                            <input type="number" name="quantity" value="{{ $item->quantity }}" min="1" max="{{ $item->product->stock }}" class="w-12 text-center border border-gray-300 rounded py-1" onchange="this.form.submit()">
                                            <button type="button" onclick="increaseQty(this)" class="px-2 py-1 bg-gray-100 rounded hover:bg-gray-200">+</button>
                                        </form>
